namespace TWG.EASDataService.DbContext.Migrations
{
    ...
    public class Configuration : DbMigrationsConfiguration<TWG.EASDataService.DbContext.DataServiceEntities>
    {
        public Configuration()
        {
            AutomaticMigrationsEnabled = false;
            AutomaticMigrationDataLossAllowed = false;
            ContextKey = "TWG.EASDataService.DbContext.DataServiceEntities";
        }

        protected override void Seed(TWG.EASDataService.DbContext.DataServiceEntities context)
        {
