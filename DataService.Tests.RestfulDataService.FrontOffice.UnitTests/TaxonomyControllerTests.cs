...
namespace DataService.Tests.RestfulDataService.FrontOffice.UnitTests
{
    ...
    public class TaxonomyControllerTests
    {
        ...
        {
            _articleRepository.Stub(r => r.GetBySector(Arg<String[]>.Is.Anything)).Return(new List<Article> { new Article() });
        ...
        {
            _articleRepository.Stub(r => r.GetByTopic(Arg<String[]>.Is.Anything)).Return(new List<Article> { new Article() });
        ...
        {
            _articleRepository.Stub(r => r.GetByArticleSection(Arg<String[]>.Is.Anything)).Return(new List<Article> { new Article() });
        ...
        {
            _articleRepository.Stub(r => r.GetByArticleSectionAndSector(Arg<String[]>.Is.Anything, Arg<String[]>.Is.Anything)).Return(new List<Article> { new Article() });
